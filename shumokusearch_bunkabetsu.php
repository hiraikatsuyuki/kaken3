...
if ($bunka == "") {
    echo "<div class=\"alert alert-info\">分科を指定してください。</div>";
    exit;
}
      ...
      <h4>件数</h4>
            <table class="table table-striped">
                ...
                while ($row_kensuu = $stmt_kensuu->fetch()) {
                    ...
                    echo "<td style=\"text-align: right\"><a href=\"./kadaisearch.php?bunka=" . $bunka .  "&shumoku=基盤研究(S)&kikanmei=" . $row_kensuu["kikanmei"] . "\">" . $row_kensuu["kibanS"] . "</td>";
                    echo "<td style=\"text-align: right\"><a href=\"./kadaisearch.php?bunka=" . $bunka .  "&shumoku=基盤研究(A)&kikanmei=" . $row_kensuu["kikanmei"] . "\">" . $row_kensuu["kibanA"] . "</td>";
                    echo "<td style=\"text-align: right\"><a href=\"./kadaisearch.php?bunka=" . $bunka .  "&shumoku=基盤研究(B)&kikanmei=" . $row_kensuu["kikanmei"] . "\">" . $row_kensuu["kibanB"] . "</td>";
                    echo "<td style=\"text-align: right\"><a href=\"./kadaisearch.php?bunka=" . $bunka .  "&shumoku=基盤研究(C)&kikanmei=" . $row_kensuu["kikanmei"] . "\">" . $row_kensuu["kibanC"] . "</td>";
                    echo "<td style=\"text-align: right\"><a href=\"./kadaisearch.php?bunka=" . $bunka .  "&shumoku=若手研究(A)&kikanmei=" . $row_kensuu["kikanmei"] . "\">" . $row_kensuu["wakateA"] . "</td>";
                    echo "<td style=\"text-align: right\"><a href=\"./kadaisearch.php?bunka=" . $bunka .  "&shumoku=若手研究(B)&kikanmei=" . $row_kensuu["kikanmei"] . "\">" . number_format($row_kensuu["wakateB"], 1) . "</td>";
                    echo "<td style=\"text-align: right\"><a href=\"./kadaisearch.php?bunka=" . $bunka .  "&shumoku=挑戦的萌芽研究&kikanmei=" . $row_kensuu["kikanmei"] . "\">" . $row_kensuu["houga"] . "</td>";
