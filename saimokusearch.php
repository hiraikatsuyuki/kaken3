...
WHERE
	gl_kakendb_anbunzumi.saimoku = :saimoku
...
$stmt_kensuu->bindValue(":saimoku", $saimoku, PDO::PARAM_STR);
$stmt_kensuu->execute();
?>
  ...
  <div class="row allCheck">
    <div class="col-md-6">
      <form class="form-horizontal" method="POST" action="./shumokusearch_saimokubetsu.php">
        <button type="submit" class="btn btn-primary">表示</button>
        <table class="table table-striped table-hover table-condensed">
          <input type="hidden" name="saimoku" value="<?php echo $saimoku; ?>">
    ...
    <div>千葉/新潟/金沢/岡山/熊本/長崎</div>
      ...
      <form method="POST" action="./shumokusearch_saimokubetsu.php">
